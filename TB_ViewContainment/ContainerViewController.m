...
- (void)swapCurrentControllerWith:(UIViewController*)viewController{
    ...
    viewController.view.frame = CGRectMake(1000,0, self.currentDetailViewController.view.frame.size.width, self.currentDetailViewController.view.frame.size.height);
    ...
    [UIView animateWithDuration:1.3
        ...
        animations:^{
            ...
            self.currentDetailViewController.view.frame = CGRectMake(-1000,
                                                                     0,
